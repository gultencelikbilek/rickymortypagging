package com.example.paggingcourse.adapter
...
import coil.load
import com.example.paggingcourse.databinding.RickMortyLayoutBinding
...
class RickMortyAdapter : PagingDataAdapter<RickMorty, RickMortyAdapter.MyViewHolder>(diffCallback){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
       return MyViewHolder(RickMortyLayoutBinding.inflate(LayoutInflater.from(parent.context),
       parent,
       false))
    }
